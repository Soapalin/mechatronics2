...
void findGoal() {
  switch(keyPosition) {
    ...
    case 11: // position at 14 18 0
      ...
      break;
    case 12: // position at 19 16.5 90
      turnLeft(90);
      forward(0.5);
      turnRight(90);
      forward(4);
      ...
      break;
    case 13: // position at 14 14.5 180
      forward(2);
      turnRight(90);
      forward(4);
      if(withinPerimeter(2.5, distanceToGoal())) {
